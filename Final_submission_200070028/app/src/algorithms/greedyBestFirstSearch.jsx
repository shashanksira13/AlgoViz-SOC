...
//Similar to Dijkstra but d
//Greedy Best-first Search is weighted and does not guarantee the shortest path
export function GreedyBFS(grid, startNode, finishNode) {
  if (!startNode || !finishNode || startNode === finishNode) {
    return false;
  }
  let queue = [];//we will sort this queue and make it like a priority queue which includes all unvisited nodes
  ...
  while (queue.length)
   {
    ...
    let neighbours = getNeighbourNodes(closestNode, grid);
